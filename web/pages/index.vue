    ...
    <div class="profile">
      <div class="profile_inner">
        ...
        Małachowski"
          ...
          width="150"
        />
        <h1>Kacper Małachowski</h1>
        <span>{{ t("home.description") }}</span>

        <!--Social Icons-->
        <div class="social-icons">
          <a
            href="https://github.com/KacperMalachowski"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/kacper-ma%c5%82achowski-940b6919b"
            target="_blank"
            rel="noopener noreferrer me"
          >
            <svg
          ...
          <a
            href="https://stackoverflow.com/users/23148781/kacper-ma%C5%82achowski"
            target="_blank"
            rel="noopener noreferrer me"
          >
            <svg
          ...
          <RouterLink to="rss" target="_blank" rel="noopener noreferrer me">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
